module User::AdsHelper
  ...
  def new_item_category_tag
    ...
    return content_tag :select, options_for_select(categories, nil), id: 'category', class: 'form-control'
  end
  ...
  def new_item_quantity_tag
    ...
    quantities << ['10+', '10+']
    return content_tag :select, options_for_select(quantities, nil), id: 'new_quantity_text', class: 'form-control'
  end
