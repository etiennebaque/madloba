...
e.sInstance,this.oApi._fnJsonString(i),e.iCookieDuration,e.sCookiePrefix,e.fnCookieCallback)},fnStateSaveParams:null,iCookieDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iScrollLoadGap:100,iTabIndex:0,oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:gon.vars['first'],sLast:gon.vars['last'],sNext:gon.vars['next'],sPrevious:gon.vars['previous']},sEmptyTable:gon.vars['no_data'],sInfo:gon.vars['showing']+" _START_ "+gon.vars['to']+" _END_ "+gon.vars['of']+" _TOTAL_ "+gon.vars['entries'],
sInfoEmpty:gon.vars['showing']+" 0 "+gon.vars['to']+" 0 "+gon.vars['of']+" 0 "+gon.vars['entries'],sInfoFiltered:"("+gon.vars['filtered_from']+" _MAX_ "+gon.vars['total_entries']+")",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:gon.vars['search'],sUrl:"",sZeroRecords:"No matching records found"},oSearch:i.extend({},j.models.oSearch),sAjaxDataProp:"aaData",sAjaxSource:null,sCookiePrefix:"SpryMedia_DataTables_",sDom:"lfrtip",sPaginationType:"two_button",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET"};
